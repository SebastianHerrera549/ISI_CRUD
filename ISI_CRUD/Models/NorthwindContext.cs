...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<AnálisisDePrecio> AnálisisDePrecios { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AnálisisDePrecio>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Análisis de precio");

            entity.Property(e => e.DiferenciaEntreElPrecioPromedioYElPrecioDelProducto)
                .HasColumnType("money")
                .HasColumnName("Diferencia entre el precio promedio y el precio del producto");
            entity.Property(e => e.NombreDelProducto)
                .HasMaxLength(40)
                .HasColumnName("Nombre del producto");
            entity.Property(e => e.PrecioPromedioDeTodosLosProductos)
                .HasColumnType("money")
                .HasColumnName("Precio promedio de todos los productos");
            entity.Property(e => e.PrecioUnitario)
                .HasColumnType("money")
                .HasColumnName("Precio unitario");
        });
